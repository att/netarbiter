...
1. Preparation (IMPORTANT: take this step from the worker nodes of your K8s cluster)
...
2. Add an OSD (IMPORTANT: take this step from the master node of your K8s cluster)
- Usage:
```
