...
### Note
[1] If you are installing in a single vcpu VM, the kube-dns pod's status will be "Pending". To make it "Running", you may install a mster node on 2+ vcpu VMs. Otherwise, you may add 1+ work nodes later.
